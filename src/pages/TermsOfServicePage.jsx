    ...
    >
      <div className="bg-primary-dark p-8 md:p-12 rounded-lg shadow-lg border border-gray-700/50">
        ...
        <div className="prose prose-invert max-w-none text-gray-300 space-y-6"> {/* Increased space-y */}
          ...
          <h2 className="text-xl font-blender text-accent-blue">제2조 (서비스 내용)</h2>
          <p>
            본 사이트는 아티스트 삼각전파사의 음악 활동, 앨범 정보, 공연 소식, 관련 미디어 자료(사진, 영상 등) 및 기타 관련 정보를 제공합니다. 서비스의 내용은 추가되거나 변경될 수 있으며, 변경 시 사이트를 통해 공지합니다.
          </p>

          <h2 className="text-xl font-blender text-accent-blue">제3조 (저작권)</h2>
          <p>
          ...
          <h2 className="text-xl font-blender text-accent-blue">제4조 (이용자의 의무)</h2>
          <p>
          ...
          <h2 className="text-xl font-blender text-accent-blue">제5조 (면책 조항)</h2>
          <p>
          ...
          <h2 className="text-xl font-blender text-accent-blue">제6조 (약관의 효력 및 변경)</h2>
           <p>
