  ...
  return (
    <ParallaxBackground className="min-h-screen pt-24 pb-16">
      ...
      <SEO
        ...
        description="삼각전파사 웹사이트의 개인정보처리방침."
        canonical="/privacy"
        noindex={false}
      />
      ...
      >
        <div className="bg-primary-dark p-8 md:p-12 rounded-lg shadow-lg border border-gray-700/50">
          <h1 className="text-3xl md:text-4xl font-blender mb-8 text-center">
            <GlitchText text="개인정보처리방침" intensity="low" interactive={true} />
          </h1>
          ...
          <div className="prose prose-invert max-w-none text-gray-300 space-y-4">
            ...
            <h2 className="text-xl font-blender text-accent-blue">
              <GlitchText text="2. 개인정보의 처리 및 보유 기간" intensity="low" interactive={true} />
            </h2>
            <p>
            ...
            <h2 className="text-xl font-blender text-accent-blue">
              <GlitchText text="3. 개인정보의 제3자 제공에 관한 사항" intensity="low" interactive={true} />
            </h2>
            <p>
